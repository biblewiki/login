...
(function(jQuery) {
    ...
    defaultOptions.common.usernameField = "#benutzername";
    ...
    defaultOptions.ui.spanError = function(options, key) {
        ...
        if (!text) { return ''; }
        return '<span style="color: #d52929; font-size: 10pt;">' + text + '</span>';
    };
    ...
    defaultOptions.ui.errorMessages = {
        wordLength: "Zu kurz",
        wordNotEmail: "Keine Email Adresse als Passwort",
        wordSimilarToUsername: "Dein Passwort enthält dein Benutzername",
